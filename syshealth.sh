...
email_add="mdtutul763@gmail.com"
...
echo "<fieldset>" >> $html
echo "<center>" >> $html
echo "<h2>System Health Checker" >> $html
...
cat $html | mail -s "`hostname` - Daily System Health Report" -a "MIME-Version: 1.0" -a "Content-Type: text/html" -a "From: Harun & Shipon <mdtutul763@gmail.com>" $email_add
